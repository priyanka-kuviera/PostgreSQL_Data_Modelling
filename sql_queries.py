...
song_select = ("""
SELECT artists.artist_id, songs.song_id FROM artists JOIN songs ON artists.artist_id = songs.artist_id WHERE (songs.title = %s AND artists.name = %s AND (songs.duration)::integer = %s);
""")
